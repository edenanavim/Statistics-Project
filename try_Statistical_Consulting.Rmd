...
```
#daycare_24month vs is atopic
```{r,fig.width=12}
plot_df_9 <- df %>% select(daycare_24month,is_atopic_first_year,is_atopic_second_year,AD_first_year, AD_24_month, FA_first_year,food_allergy_24_month, ABX_fisrt_year,inhalation_24_month) %>% drop_na() %>% group_by(daycare_24month) %>% summarise(is_atopic_first_year= mean(is_atopic_first_year), is_atopic_second_year= mean(is_atopic_second_year),AD_first_year = mean(AD_first_year), AD_24_month = mean(AD_24_month), FA_first_year = mean(FA_first_year),food_allergy_24_month = mean(food_allergy_24_month), ABX_fisrt_year = mean(ABX_fisrt_year),inhalation_24_month = mean(inhalation_24_month)) %>% gather(chronic_disease, mean, is_atopic_first_year:inhalation_24_month, factor_key=TRUE)

ggplot(plot_df_9,aes(x=as.factor(chronic_disease), y= mean, fill = as.factor(daycare_24month))) +
    geom_col(position = "dodge") + scale_fill_discrete(name = "daycare_24month")+ xlab("chronic_disease") + ylab("percent of disease")# +scale_fill_manual(values=c('dodgerblue4', 'darkorange1', 'green4'))
...
```
#vaccines_24month vs is atopic
```{r,fig.width=12}
plot_df_11 <- df %>% select(vaccines_24month,is_atopic_first_year,is_atopic_second_year,AD_first_year, AD_24_month, FA_first_year,food_allergy_24_month, ABX_fisrt_year,inhalation_24_month) %>% drop_na() %>% group_by(vaccines_24month) %>% summarise(is_atopic_first_year= mean(is_atopic_first_year), is_atopic_second_year= mean(is_atopic_second_year),AD_first_year = mean(AD_first_year), AD_24_month = mean(AD_24_month), FA_first_year = mean(FA_first_year),food_allergy_24_month = mean(food_allergy_24_month), ABX_fisrt_year = mean(ABX_fisrt_year),inhalation_24_month = mean(inhalation_24_month)) %>% gather(chronic_disease, mean, is_atopic_first_year:inhalation_24_month, factor_key=TRUE)

ggplot(plot_df_11,aes(x=as.factor(chronic_disease), y= mean, fill = as.factor(vaccines_24month))) +
    geom_col(position = "dodge") + scale_fill_discrete(name = "vaccines_24month")+ xlab("chronic_disease") + ylab("percent of disease")# +scale_fill_manual(values=c('dodgerblue4', 'darkorange1', 'green4'))

```
#number_inhalation vs is atopic
```{r,fig.width=12}
plot_df_11 <- df %>% select(number_inhalation,is_atopic_first_year,is_atopic_second_year,AD_first_year, AD_24_month, FA_first_year,food_allergy_24_month, ABX_fisrt_year,inhalation_24_month) %>% drop_na() %>% group_by(number_inhalation) %>% summarise(is_atopic_first_year= mean(is_atopic_first_year), is_atopic_second_year= mean(is_atopic_second_year),AD_first_year = mean(AD_first_year), AD_24_month = mean(AD_24_month), FA_first_year = mean(FA_first_year),food_allergy_24_month = mean(food_allergy_24_month), ABX_fisrt_year = mean(ABX_fisrt_year),inhalation_24_month = mean(inhalation_24_month)) %>% gather(chronic_disease, mean, is_atopic_first_year:inhalation_24_month, factor_key=TRUE)

ggplot(plot_df_11,aes(x=as.factor(chronic_disease), y= mean, fill = as.factor(number_inhalation))) +
    geom_col(position = "dodge") + scale_fill_discrete(name = "number_inhalation")+ xlab("chronic_disease") + ylab("percent of disease")# +scale_fill_manual(values=c('dodgerblue4', 'darkorange1', 'green4'))

```
#AD_treatment_24_month vs is atopic
```{r,fig.width=12}
plot_df_12 <- df %>% select(AD_treatment_24_month,is_atopic_first_year,is_atopic_second_year,AD_first_year, AD_24_month, FA_first_year,food_allergy_24_month, ABX_fisrt_year,inhalation_24_month) %>% drop_na() %>% group_by(AD_treatment_24_month) %>% summarise(is_atopic_first_year= mean(is_atopic_first_year), is_atopic_second_year= mean(is_atopic_second_year),AD_first_year = mean(AD_first_year), AD_24_month = mean(AD_24_month), FA_first_year = mean(FA_first_year),food_allergy_24_month = mean(food_allergy_24_month), ABX_fisrt_year = mean(ABX_fisrt_year),inhalation_24_month = mean(inhalation_24_month)) %>% gather(chronic_disease, mean, is_atopic_first_year:inhalation_24_month, factor_key=TRUE)

ggplot(plot_df_12,aes(x=as.factor(chronic_disease), y= mean, fill = as.factor(AD_treatment_24_month))) +
    geom_col(position = "dodge") + scale_fill_discrete(name = "AD_treatment_24_month")+ xlab("chronic_disease") + ylab("percent of disease")# +scale_fill_manual(values=c('dodgerblue4', 'darkorange1', 'green4'))

```
#number_steroid_treat vs is atopic
```{r,fig.width=12}
plot_df_13 <- df %>% select(number_steroid_treat,is_atopic_first_year,is_atopic_second_year,AD_first_year, AD_24_month, FA_first_year,food_allergy_24_month, ABX_fisrt_year,inhalation_24_month) %>% drop_na() %>% group_by(number_steroid_treat) %>% summarise(is_atopic_first_year= mean(is_atopic_first_year), is_atopic_second_year= mean(is_atopic_second_year),AD_first_year = mean(AD_first_year), AD_24_month = mean(AD_24_month), FA_first_year = mean(FA_first_year),food_allergy_24_month = mean(food_allergy_24_month), ABX_fisrt_year = mean(ABX_fisrt_year),inhalation_24_month = mean(inhalation_24_month)) %>% gather(chronic_disease, mean, is_atopic_first_year:inhalation_24_month, factor_key=TRUE)

ggplot(plot_df_13,aes(x=as.factor(chronic_disease), y= mean, fill = as.factor(number_steroid_treat))) +
    geom_col(position = "dodge") + scale_fill_discrete(name = "number_steroid_treat")+ xlab("chronic_disease") + ylab("percent of disease")# +scale_fill_manual(values=c('dodgerblue4', 'darkorange1', 'green4'))

```
#vaccines_24month vs is atopic:
```{r,fig.width=12}
plot_df_14 <- df %>% select(vaccines_24month,is_atopic_first_year,is_atopic_second_year,AD_first_year, AD_24_month, FA_first_year,food_allergy_24_month, ABX_fisrt_year,inhalation_24_month) %>% drop_na() %>% group_by(vaccines_24month) %>% summarise(is_atopic_first_year= mean(is_atopic_first_year), is_atopic_second_year= mean(is_atopic_second_year),AD_first_year = mean(AD_first_year), AD_24_month = mean(AD_24_month), FA_first_year = mean(FA_first_year),food_allergy_24_month = mean(food_allergy_24_month), ABX_fisrt_year = mean(ABX_fisrt_year),inhalation_24_month = mean(inhalation_24_month)) %>% gather(chronic_disease, mean, is_atopic_first_year:inhalation_24_month, factor_key=TRUE)

ggplot(plot_df_14,aes(x=as.factor(chronic_disease), y= mean, fill = as.factor(vaccines_24month))) +
    geom_col(position = "dodge") + scale_fill_discrete(name = "vaccines_24month")+ xlab("chronic_disease") + ylab("percent of disease")# +scale_fill_manual(values=c('dodgerblue4', 'darkorange1', 'green4'))

```
#binary vs catagoric:
```{r}
cat <- c("SES","mother_education", "number_of_children","preganancy_number","type_of_pregnancy","number_of_ABX_first_year","number_ABX_treatment_24_months","nursing_setup_at_12mo","daycare_24month","number_inhalation","AD_treatment_24_month","number_steroid_treat")
binary = c("Jew/Arab", "gender","mother_asthma","mother_atopic_dermatitis","mother_Allergic_rhinitis","mother_food_allergy","father_asthma","father_atopic_dermatitis","father_Allergic_rhinitis","father_food_allergy","sibling1_asthma","sibling1_atopic_dermatitis","sibling1_Allergic_rhinitis","sibling1_food_allergy","sibling2_asthma","sibling2_atopic_dermatitis","sibling2_Allergic_rhinitis","sibling2_food_allergy","sibling3_asthma","sibling3_atopic_dermatitis","sibling3_Allergic_rhinitis","sibling3_food_allergy","sibling4_asthma","sibling4_atopic_dermatitis","sibling4_Allergic_rhinitis","sibling4_food_allergy","HRAD_first_year","family_Atopic_diseases","mother_Atopic_diseases","father_Atopic_diseases","sibling_Atopic_diseases")
...
cat <- c(SES,mother_education, number_of_children,preganancy_number,type_of_pregnancy,number_of_ABX_first_year,number_ABX_treatment_24_months,nursing_setup_at_12mo,daycare_24month,vaccines_24month,number_inhalation,AD_treatment_24_month,number_steroid_treat)
```
...
```{r, warning=F}
SES_category <- function(kpi){
  return (ggplot(df, aes(SES, fill=as.factor(df[[kpi]]))) + geom_bar(adjust=1.5) + ggtitle(paste0(kpi, ' vs. SES')))}
lapply(Categoric_variables , SES_category)

gender_category <- function(kpi){
  return (ggplot(df, aes(gender, fill=as.factor(df[[kpi]]))) + geom_bar(adjust=1.5) + ggtitle(paste0(kpi, ' vs. gender')))}
lapply(Categoric_variables , gender_category)

mother_education_category <- function(kpi){
  return (ggplot(df, aes(mother_education, fill=as.factor(df[[kpi]]))) + geom_bar(adjust=1.5) + ggtitle(paste0(kpi, ' vs. mother_education')))}
lapply(Categoric_variables , mother_education_category)

family_Atopic_diseases_category <- function(kpi){
  return (ggplot(df, aes(family_Atopic_diseases, fill=as.factor(df[[kpi]]))) + geom_bar(adjust=1.5) + ggtitle(paste0(kpi, ' vs. family_Atopic_diseases')))}
lapply(Categoric_variables , family_Atopic_diseases_category)
