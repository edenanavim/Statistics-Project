...
# create a category SES variable :
...
mdl1 <- glm(is_atopic_first_year ~ SES_group + gender + mother_Atopic_diseases + father_Atopic_diseases + # + sibling_Atopic_diseases
             mother_year_birth + mother_education + number_of_children + type_of_pregnancy + DOB  , data = df, family = "binomial")
summary(mdl1)
...
mdl2 <- glm(is_atopic_second_year ~ SES + gender + vaccine_12mo + feeding_type + mother_Atopic_diseases + father_Atopic_diseases + sibling_Atopic_diseases + 
             mother_year_birth + mother_education + number_of_children + type_of_pregnancy + nursing_setup_at_12mo + is_atopic_first_year + DOB, 
...
gam_mdl <- gam(is_atopic_first_year~ SES_group + gender + 
