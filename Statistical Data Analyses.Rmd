...
# mdl_gam1 = gam(is_atopic_first_year ~ SES + gender + 
#              mother_Atopic_diseases + father_Atopic_diseases + sibling_Atopic_diseases + 
#              mother_year_birth + mother_education + number_of_children + 
#              type_of_pregnancy + s(DOB_cont, bs = "cr"), data = df)
# summary(mdl_gam1)
# plot(mdl_gam1)
...
mdl_gam1 <- glm(is_atopic_first_year ~ SES + gender + mother_Atopic_diseases + father_Atopic_diseases + sibling_Atopic_diseases + 
             mother_year_birth + mother_education + number_of_children + type_of_pregnancy + bs(DOB_cont, knots = c(g1,g2)) ,data=df %>% drop_na(), family = 'binomial')
