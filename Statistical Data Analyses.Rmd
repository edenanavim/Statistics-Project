...
mdl1 <- glm(is_atopic_first_year ~ SES_group + gender + number_of_sibilings + 
               type_of_pregnancy + feeding_type +  
...
mdl2 <- glm(is_atopic_second_year ~ SES_group + gender + number_of_sibilings + 
              ...
              father_Atopic_diseases + mother_Atopic_diseases + 
              mother_year_birth + mother_education +  
              vaccine_12mo + nursing_setup_at_12mo + is_atopic_first_year + ABX_fisrt_year + 
              covid_time , data=df_mdl, family='binomial')
...
print('logistic first year:')
summary(mdl1)
print('logistic secound year:')
summary(mdl2)
print('GAM first year:')
summary(gam1)
print('GAM secound year:')
summary(gam2)
```
...
typical_baby_plot1 <- ggplot(typical_baby, aes(DOB, gam_predict_first_year)) +  
                        ...
                        geom_line(aes(DOB, reg_predict_first_year, col = Birth_date), size = 1, linetype=2) +
...
typical_baby_plot2 <- ggplot(typical_baby, aes(DOB, gam_predict_second_year)) +
  ...
  geom_line(aes(DOB, reg_predict_second_year, col = Birth_date), size = 1, linetype=2) +
...
# ggsave('poster_graph.jpeg',typical_baby_plot2, width =8, height =6)
